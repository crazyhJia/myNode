...
var options = {
    ...
    nameCache: JSON.parse(fsdir.readFileSync(cacheFileName, "utf8"))
};
fsdir.writeFileSync("part1.js", UglifyJS.minify({
    "file1.js": fsdir.readFileSync("file1.js", "utf8"),
    "file2.js": fsdir.readFileSync("file2.js", "utf8")
}, options).code, "utf8");
fsdir.writeFileSync("part2.js", UglifyJS.minify({
    "file3.js": fsdir.readFileSync("file3.js", "utf8"),
    "file4.js": fsdir.readFileSync("file4.js", "utf8")
}, options).code, "utf8");
fsdir.writeFileSync(cacheFileName, JSON.stringify(options.nameCache), "utf8");
```
...
```
```javascript
var code = fsdir.readFileSync("test.js", "utf8");
...
```javascript
var result = UglifyJS.minify(fsdir.readFileSync("input.js", "utf8"), {
    compress: {
        dead_code: true,
        global_defs: {
            DEBUG: false
